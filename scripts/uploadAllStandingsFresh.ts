/**
 * FRESH STANDINGS UPLOAD - Upload all 33 standings files with refactored Firebase
 */
...
async function uploadStandings(season: number, week: number): Promise<boolean> {
  ...
  // Clean data - Firebase doesn't like NaN, Infinity, undefined
...
async function main() {
  console.log('\n🚀 UPLOADING ALL STANDINGS WITH FRESH FIREBASE SETUP\n');
